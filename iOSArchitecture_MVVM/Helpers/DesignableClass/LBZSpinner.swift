...
@IBDesignable class LBZSpinner : UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    let heightTableviewCell: CGFloat = 35
    
    var heightTableview: CGFloat = 150
    ...
    //spinner
    @IBInspectable var textFont: UIFont = UIFont.systemFont(ofSize: 14.0) { didSet{ updateUI() } }
...
//        NotificationCenter.default.addObserver(self, selector: #selector(LBZSpinner.orientationChanged), name: NSNotification.Name.UIDevice.orientationDidChangeNotification, object: nil)
       ...
       // lastSuperView?.backgroundColor = UIColor.red
    }
